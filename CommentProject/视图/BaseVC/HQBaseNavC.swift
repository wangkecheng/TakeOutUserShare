...
class HQBaseNavC: UINavigationController {
    ...
    self.navigationBar.setBackgroundImage(ImageWithColor(color:UIColorFromRGB(R: 7, G: 113, B: 197)!), for: UIBarMetrics.default)
        ...
        titleAttribute.setObject(UIFont.systemFont(ofSize: 16), forKey: NSAttributedStringKey.font as NSCopying)
        self.navigationBar.titleTextAttributes = (titleAttribute as! [NSAttributedStringKey : Any])
